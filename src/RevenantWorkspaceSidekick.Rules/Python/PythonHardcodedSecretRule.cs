...
/// <summary>RWS-PY-006: Hardcoded secrets.</summary>
public sealed partial class PythonHardcodedSecretRule : IRule
{
    ...
    public IEnumerable<Finding> Analyze(FileContext context)
    {
        foreach (Match match in SecretRegex().Matches(context.Content))
        {
            ...
            yield return new Finding(
                ...
                Fix: "Use environment variables or a secure secret management system to load credentials at runtime."
            );
        }
    }
